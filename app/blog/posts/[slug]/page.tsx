...
const Postpage = (props: any) => {
  ...
  return (
    <div className=" bg-gray1 w-screen h-full flex flex-col">
      <Link href={"/blog"} className=" w-screen text-teal-400 pt-8 pl-14 pb-4">
        {" "}
        &lt;- Back to Blog
      </Link>
      ...
      <div className="flex justify-center">
        <article
          className=" prose md:prose-lg prose-p:text-base prose-h1:text-white prose-th:text-white prose-table:bg-gray-800 prose-strong:text-white  prose-table:text-center prose-table:rounded-lg prose-table:text-white
        ...
        >
          <Markdown className="w-ful m-0">{post.content}</Markdown>
        </article>
      </div>
    </div>
  );
